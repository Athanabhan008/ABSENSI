                ...
                <div class="row">
                    <div class="col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" placeholder="No.handphone" name="no_hp" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1" style="background-color: rgb(209, 209, 209)">Password</span>
                            <input type="password" class="form-control" placeholder="Email" name="password" aria-label="Username" aria-describedby="basic-addon1">
                          </div>
                    </div>
                </div>
